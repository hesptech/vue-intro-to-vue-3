app.component('product-display', {
    ...
    `<div class="product-display">
        ...
        <review-form @review-submitted="addReview" @reccomend-submitted="addReccomend"></review-form>
        <div v-if="reccomend"><h3>Reccomended: {{ reccomend }}</h3></div>
    </div>`,
    data() {
        return {
            product: 'Socks',
